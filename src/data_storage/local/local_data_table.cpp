...
{
	LocalDataTable::LocalDataTable(const common::UUID& uuid, std::string name, const std::vector<ColumnParameters> &columns)
	...
	std::shared_ptr<LocalDataTable> LocalDataTable::make_shared(const common::UUID& uuid, std::string name, const std::vector<ColumnParameters>& columns)
	{
